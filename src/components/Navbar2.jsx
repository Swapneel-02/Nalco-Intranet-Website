...
const Navbar2 = (props) => {
  ...
  return (
    <div>
      <>
        <ul id="navbar2">
        <div style={{backgroundColor:"burlywood",borderTopRightRadius:"6px"}}><i class="fa-solid fa-bars" onClick={(e)=>nav(e)}></i></div>
  ...
  <span class="slider"></span>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <a href="/">
                      Membership For Executive Family Welfare Scheme And
                      Nomination
                    </a>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <a href="/">
                      Request For Guest House Accomodation at S&P Complex
                    </a>
                  </li>
                  <li>
                    <a href="/">
                      Request For Guest House Accomodation at Bhubaneswar
                    </a>
                  </li>
                  <li>
        ...
        <div id="nav3" onClick={(e)=>nav(e)}><i class="fa-regular fa-square-caret-down"></i></div>
      </>
    </div>
  );
};
