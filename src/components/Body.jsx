...
const Body = () => {
  ...
  const cdate = [
    [1, "08-05-2023", "def jayanti"],
    [2, "15-05-2023", "abc jayanti"],
    [3, "08-06-2023", "xyj jayanti"],
  ];
  const c1date = [
    [1, "09-05-2023", "def jayanti"],
    [2, "16-05-2023", "abc jayanti"],
    [3, "09-06-2023", "xyj jayanti"],
  ];
  ...
  useEffect(() => {
    if (eleref.current) {
      for (
        let i = 2;
        i <
        document.getElementsByClassName("wrapper")[0].children[0]
          .childElementCount;
        i = i + 2
      ) {
        document.getElementsByClassName("wrapper")[0].children[0].children[
          i
  ...
  const content = () => {
    axios
      .get(
        "https://newsdata.io/api/1/news?apikey=pub_103768b7e3375a6b6778cce86a9b1348bbc37&q=india"
      )
      .then((res) => {
  ...
  useEffect(() => {
    if (activeTab2 === 6) {
      document.getElementsByClassName("col1div2")[0].style.backgroundImage =
        "url('" + bday4 + "')";
      document.getElementsByClassName("col1div2")[0].style.backgroundRepeat =
        "no-repeat";
      document.getElementsByClassName("col1div2")[0].style.backgroundSize =
        "100% 100%";
      ...
      <div id="body">
                  ...
                  <p ref={eleref} className="wrapper">
                    <table>
                      <tr>
                        ...
                        <th style={{ width: "70%", padding: "2px" }}>
                          Circular
                        </th>
                        <th style={{ width: "10%", padding: "2px" }}>View</th>
                      </tr>
                      {data1.map((value) => {
                        return (
                          <>
                ...
                {activeTab1 === 5 && (
                  <p>
                    <ul>
                      <li>
                        <a href="/">
                          Checklists for Bills Submission to Finance Deptt
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="/">
                          Compendium on Guidlines on Works,Goods and Services -
                          A Ready Reckner
                        </a>
                      </li>
                    </ul>
                  ...
                  <p>
                    <ul>
                      ...
                      <li>
                        Downloads:{" "}
                        <span>
                          <a href="/">Smelter</a>|<a href="/">Refinery</a>|
                          <a href="/">CPP</a>
                        </span>
                      </li>
                      <li>
                  ...
                  <p>
                    <ul>
                      ...
                      <li>
                        MIS :{" "}
                        <span>
                          <a href="/">Smelter</a>|<a href="/">Mines</a>|
                          <a href="/">Refinery</a>
                        </span>
                      </li>
                      <li>
                        <a href="/">Procedure Of Making OCR based PDF files</a>
                      </li>
                      <li>
                        <a href="/">How to digitally sign a document</a>
                      </li>
                      <li>
                        <a href="/">
                          Guidlines For Indian Government Websites(GIGW)
                        </a>
                      </li>
                    </ul>
                  </p>
        ...
        <div className="col3">
          <div id="etccontent">
            <p
              className="col3p"
              onClick={() => direct("https://www.google.com")}
            >
              <p>
          ...
          <div id="twitterfeed" style={{display:"block"}}>
          <div style={{display:"inline"}}>
            <i class="fa-brands fa-twitter fa-lg" style={{color:'#005eff'}}></i> &nbsp;&nbsp;
            <div id="mom">
              <input type="radio" name="radio1" id="nalcotweet" onClick={()=>handleClicks2(10)} defaultChecked={true}/>&nbsp;
              <label for="nalcotweet">Ministry of Mines</label></div> 
              <div id="nalcotweet"><input type="radio" name="radio1" id="minestweet" onClick={()=>handleClicks2(11)}/>&nbsp;<label for="minestweet">Nalco</label></div>
            </div>
            <div>
            <div>
              {
